...
class FaissVectorStoreInitializer(BaseVectorStoreInitializer):
    """Loads the FAISS index from disk, or builds it from documents if absent."""
...
# Back-compat alias: the class was previously named VectorStoreInitializer.
VectorStoreInitializer = FaissVectorStoreInitializer
